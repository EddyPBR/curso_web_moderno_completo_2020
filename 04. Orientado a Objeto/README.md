...
<br />
<h2 align="center">04. Orientado a Objeto</h2>
<br />

## :eyes: Visão Geral 
  No capítulo de Programação orientada a objetos (POO) serão abordados estratégias de criação
  de objetos, objetos constantes, notacao literal, geters & setters, herança, polimorfismo, encapsulamento, JSON vs Objeto e Classes.
<br /><br />
